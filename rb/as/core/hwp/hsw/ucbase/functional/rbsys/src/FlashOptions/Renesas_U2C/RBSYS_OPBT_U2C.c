...
/* realized interfaces */
#include "RBSYS_OPBT_U2C.h" //< for RBSECTION_
#include "RBSYS_OPBT_U2C_SanityCheck.h" //< for RBLCF_HSM_CFLASH_
...
static const RBSYS_FlashConfigArea_ExpectedValues_t RBSYS_OPBT_ExpectedValues[] =
{
    ...
    {RBSYS_FlashConfigAreaSetting_OPBT9,          OPBT9}, //does not exist in U2C
...
tssaConfig2 RBSYS_FlashConfigArea_ssaConfig2 = {
      ...
      0xFF280000u                                         /*ICUM_OPBT3*/, //< Secure Data Flash Region Start Address for K0, K1, K3ED
...
/* Reserved space of BPA0_OTP that must not be programmed (0xFF323240 - 0xFF3232BF) */

RBSECTION_START_BPA0_OTP1
tbpa0Otp1Settings RBSYS_FlashConfigArea_bpa0Otp1Config = {
    /* second separate part of BPA0_OTP setting (0xFF3232C0 - 0xFF3232FF), reserved but needs to be programmed all 0xFFFFFFFF */
    {RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,
    RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT}
};
RBSECTION_END_BPA0_OTP1

/* Reserved space of BPA0_OTP that must not be programmed (0xFF323300 - 0xFF3233DF) */
...
/* Reserved space of BPA0_CONFIG that must not be programmed (0xFF323480 - 0xFF32357F) */

RBSECTION_START_BPA0_CONFIG1A
tbpa0Config1a RBSYS_FlashConfigArea_bpaConfig1a = {
    /* second separate part of BPA0_CONFIG1 setting (0xFF323580 - 0xFF3235FF), reserved but needs to be programmed all 0xFFFFFFFF */
    {RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,
     RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,
     RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,
     RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT,RESERVED_32BIT}
};
RBSECTION_END_BPA0_CONFIG1A

/* Reserved space of BPA0_CONFIG that must not be programmed (0xFF323600 - 0xFF3236FF) */
