...
/* -------- Task declarations --------- */
#define TaskBaseCtrlCycx200Background (&Os_const_tasks1[0])
#define OS_CORE_FOR_TaskBaseCtrlCycx200Background (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskBaseCtrlCycx200Background (0U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx200Background (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx200Background (0U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx200Background)
#define TaskEventCtrlExtPrio2 (&Os_const_tasks1[1])
#define OS_CORE_FOR_TaskEventCtrlExtPrio2 (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskEventCtrlExtPrio2 (1U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskEventCtrlExtPrio2 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskEventCtrlExtPrio2 (1U) /* [$UKS 2185] */
DeclareTask(TaskEventCtrlExtPrio2)
#define TaskEventCtrlExtPrio1 (&Os_const_tasks1[2])
#define OS_CORE_FOR_TaskEventCtrlExtPrio1 (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskEventCtrlExtPrio1 (2U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskEventCtrlExtPrio1 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskEventCtrlExtPrio1 (2U) /* [$UKS 2185] */
DeclareTask(TaskEventCtrlExtPrio1)
...
#define OS_INDEX_FOR_TaskBaseCtrlCycx24 (3U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_TaskBaseCtrlCycx8 (4U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx8)
#define TaskBaseCtrlCycx4pLow (&Os_const_tasks1[3])
#define OS_CORE_FOR_TaskBaseCtrlCycx4pLow (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskBaseCtrlCycx4pLow (3U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx4pLow (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx4pLow (5U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx4pLow)
...
#define OS_INDEX_FOR_TaskBaseCtrlCycx4 (6U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_TaskFlexray (10U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_TaskBaseCtrlCycx1High (11U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_Task1ms (12U) /* [$UKS 2185] */
DeclareTask(Task1ms)
...
#define OS_INDEX_FOR_Task0p5ms (13U) /* [$UKS 2185] */
DeclareTask(Task0p5ms)
#define TaskInitP (&Os_const_tasks1[5])
#define OS_CORE_FOR_TaskInitP (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskInitP (5U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskInitP (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskInitP (14U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_TaskInit (15U) /* [$UKS 2185] */
...
#define OS_INDEX_FOR_TaskTPSWKillCore0 (16U) /* [$UKS 2185] */
DeclareTask(TaskTPSWKillCore0)
#define TaskTPSWKillCore1 (&Os_const_tasks1[6])
#define OS_CORE_FOR_TaskTPSWKillCore1 (1U) /* [$UKS 1909] */
#define OS_TPL_FOR_TaskTPSWKillCore1 (6U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskTPSWKillCore1 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskTPSWKillCore1 (17U) /* [$UKS 2185] */
