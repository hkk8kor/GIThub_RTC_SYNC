...
#define GetCoreID() ((CoreIdType)/*lint --e(9034) [MISRA 2012 Dir 10.3] Depends on CoreIdType size */((OS_STSR(OS_HTCFG0, OS_SELID_2) >> OS_PEID_BIT1) & 1U))  /* [$UKS 1619] [$UKS 1620] [$UKS 1621] */
...
#define Os_ErrorInformation (Os_const_coreconfiguration[((OS_STSR(OS_HTCFG0, OS_SELID_2) >> OS_PEID_BIT1) & 1U)].controlled->ErrorInformation)
