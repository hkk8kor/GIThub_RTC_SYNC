...
#elif defined (OS_START_SEC_UNTRUSTEDAPPCORE0_LIB)
  #undef      OS_START_SEC_UNTRUSTEDAPPCORE0_LIB
#elif defined (OS_STOP_SEC_UNTRUSTEDAPPCORE0_LIB)
  #undef      OS_STOP_SEC_UNTRUSTEDAPPCORE0_LIB

#elif defined (OS_START_SEC_UNTRUSTEDAPPCORE1_LIB)
  #undef      OS_START_SEC_UNTRUSTEDAPPCORE1_LIB
#elif defined (OS_STOP_SEC_UNTRUSTEDAPPCORE1_LIB)
  #undef      OS_STOP_SEC_UNTRUSTEDAPPCORE1_LIB
