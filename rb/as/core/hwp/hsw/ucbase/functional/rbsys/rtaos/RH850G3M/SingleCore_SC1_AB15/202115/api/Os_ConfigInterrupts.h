...
#define Os_IntChannel_GTM_ATOM0_IRQ0 (69U)
#define Os_IntChannel_ISR0p5ms (69U)
#define Os_EIC69 ((*(volatile uint16 *) (0xFFFFB08AU)))
#define Os_Disable_EI_Channel_69() OS_SET1((volatile char *)&Os_EIC69, OS_ICR_EIMK)
#define Os_Enable_EI_Channel_69() OS_CLR1((volatile char *)&Os_EIC69, OS_ICR_EIMK)
#define Os_Clear_EI_Channel_69() OS_DI(); (Os_EIC69 &= OS_ICR_INTERRUPT_CLEARED_MSK); OS_EI();
#define Os_Disable_ISR0p5ms() Os_Disable_EI_Channel_69()
#define Os_Enable_ISR0p5ms() Os_Enable_EI_Channel_69()
#define Os_Clear_ISR0p5ms() Os_Clear_EI_Channel_69()
...
#define Os_IntChannel_Reserved_EI_INT_181 (181U)
...
#define Os_IntChannel_Reserved_EI_INT_197 (197U)
