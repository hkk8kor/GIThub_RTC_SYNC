...
#define OS_NUM_TASKS (19U)
#define OS_NUM_ISRS (15U)
...
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx20Guest(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx10Guest(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx8(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx4Guest(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx4(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx2Guest(void);
...
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx1Guest(void);
...
extern FUNC(void, OS_CODE) Os_Entry_ISRCAN6REC(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRCAN6TRX(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRCAN8REC(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRCAN8TRX(void);
