...
extern VAR(void *, OS_VAR_NO_INIT) Os_EnhancedIsolationStack[2U];
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
...
#define GetCoreID() ((CoreIdType)/*lint --e(9034) [MISRA 2012 Dir 10.3] Depends on CoreIdType size */Os_TgtCoreID())  /* [$UKS 1619] [$UKS 1620] [$UKS 1621] */
...
#define Os_ErrorInformation (Os_const_coreconfiguration[Os_TgtCoreID()].controlled->ErrorInformation)
...
extern FUNC(ProtectionReturnType, OS_CALLOUT_CODE) Os_Cbk_IsUntrustedCodeOK(Os_EIContextBuffType * Os_stack_context, Os_UntrustedContextRefType Os_EIApplicationContext);
