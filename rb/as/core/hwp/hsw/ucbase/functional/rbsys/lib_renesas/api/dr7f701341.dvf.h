...
/*                                                                            */
/* Device     : RH/RH850G3M/R7F701341                                         */
/* File Name  : dr7f701341.dvf.h                                          */
...
/*              \dr7f701341.dvf -o=..\output\update\inc_nobit\dr7f701341. */
/*              dvf.h                                                         */
/* Date       : 8/26/2022                                                     */
...
/*                                                                            */
/******************************************************************************/
#ifndef DR7F701341_DVF_H__
#define DR7F701341_DVF_H__
...
{                                                          /* Module           */
    ...
    R_type1 TOCC;                                          /* TOCC             */
    R_type1 TOCV;                                          /* TOCV             */
    uint8  dummy69[16];                                    /* Reserved         */
    R_type1 ECR;                                           /* ECR              */
    R_type1 PSR;                                           /* PSR              */
    R_type1 TDCR;                                          /* TDCR             */
    uint8  dummy70[4];                                     /* Reserved         */
    R_type1 IR;                                            /* IR               */
    R_type1 IE;                                            /* IE               */
    R_type1 ILS;                                           /* ILS              */
    R_type1 ILE;                                           /* ILE              */
    uint8  dummy71[32];                                    /* Reserved         */
    R_type1 GFC;                                           /* GFC              */
    R_type1 SIDFC;                                         /* SIDFC            */
    R_type1 XIDFC;                                         /* XIDFC            */
...
{                                                          /* Module           */
    ...
    uint8  dummy79[4];                                     /* Reserved         */
    uint32 EDGSEL0;                                        /* EDGSEL0          */
    uint8  dummy80[4];                                     /* Reserved         */
...
{                                                          /* Module           */
    R_type0 CTL0;                                          /* CTL0             */
    uint8  dummy81[15];                                    /* Reserved         */
    uint32 CTL1;                                           /* CTL1             */
    uint16 CTL2;                                           /* CTL2             */
    uint8  dummy82[4074];                                  /* Reserved         */
    uint32 MCTL1;                                          /* MCTL1            */
    uint32 MCTL2;                                          /* MCTL2            */
    uint32 TX0W;                                           /* TX0W             */
    uint16 TX0H;                                           /* TX0H             */
...
{                                                          /* Module           */
    R_type0 CTL0;                                          /* CTL0             */
    uint8  dummy91[15];                                    /* Reserved         */
    uint32 CTL1;                                           /* CTL1             */
    uint16 CTL2;                                           /* CTL2             */
    uint8  dummy92[4074];                                  /* Reserved         */
    uint32 MCTL1;                                          /* MCTL1            */
    uint32 MCTL2;                                          /* MCTL2            */
    uint32 TX0W;                                           /* TX0W             */
    uint16 TX0H;                                           /* TX0H             */
...
{                                                          /* Module           */
    ...
    uint32 STR;                                            /* STR              */
    uint32 STC;                                            /* STC              */
    uint8  dummy107[8];                                    /* Reserved         */
    R_type4 IS;                                            /* IS               */
    R_type4 RM;                                            /* RM               */
    uint8  dummy108[8];                                    /* Reserved         */
    uint32 CNT0L;                                          /* CNT0L            */
    uint32 CNT0H;                                          /* CNT0H            */
    uint8  dummy109[8];                                    /* Reserved         */
...
{                                                          /* Module           */
    ...
    uint8  dummy137[24];                                   /* Reserved         */
    uint32 ICMIRQGMCS0CEI;                                 /* ICMIRQGMCS0CEI   */
    uint8  dummy138[2456];                                 /* Reserved         */
    ...
    uint8  dummy170[117080];                               /* Reserved         */
...
{                                                          /* Module           */
    ...
    uint8  EMU0;                                           /* EMU0             */
    uint8  dummy211[231];                                  /* Reserved         */
} R_CLMA0;
typedef struct
{                                                          /* Module           */
    uint8  CTL0;                                           /* CTL0             */
    uint8  dummy212[7];                                    /* Reserved         */
    uint16 CMPL;                                           /* CMPL             */
    ...
    uint8  EMU0;                                           /* EMU0             */
    uint8  dummy217[231];                                  /* Reserved         */
} R_CLMA1;
typedef struct
{                                                          /* Module           */
    uint8  CTL0;                                           /* CTL0             */
    uint8  dummy218[7];                                    /* Reserved         */
    uint16 CMPL;                                           /* CMPL             */
    ...
    uint8  EMU0;                                           /* EMU0             */
    uint8  dummy223[231];                                  /* Reserved         */
} R_CLMA2;
typedef struct
{                                                          /* Module           */
    uint8  CTL0;                                           /* CTL0             */
    uint8  dummy224[7];                                    /* Reserved         */
    uint16 CMPL;                                           /* CMPL             */
...
{                                                          /* Module           */
    ...
    uint8  MPXOWR;                                         /* MPXOWR           */
    uint8  dummy243[7];                                    /* Reserved         */
    uint8  ADCR2;                                          /* ADCR2            */
    uint8  dummy244[7];                                    /* Reserved         */
    uint8  ADENDP0;                                        /* ADENDP0          */
    uint8  dummy245[31];                                   /* Reserved         */
    uint8  SFTCR;                                          /* SFTCR            */
    ...
    uint8  ULER;                                           /* ULER             */
    uint8  dummy249[3];                                    /* Reserved         */
    uint8  OWER;                                           /* OWER             */
    uint8  dummy250[3];                                    /* Reserved         */
    uint8  PER;                                            /* PER              */
    uint8  dummy251[3];                                    /* Reserved         */
    uint8  IDER;                                           /* IDER             */
    uint8  dummy252[23];                                   /* Reserved         */
    ...
    uint8  dummy256[3];                                    /* Reserved         */
    uint8  THBHLDSTCR;                                     /* THBHLDSTCR       */
    uint8  dummy257[11];                                   /* Reserved         */
    uint8  THACR;                                          /* THACR            */
    uint8  dummy258[3];                                    /* Reserved         */
    uint8  THBCR;                                          /* THBCR            */
    uint8  dummy259[11];                                   /* Reserved         */
    uint8  THER;                                           /* THER             */
    uint8  dummy260[3];                                    /* Reserved         */
    uint16 THGSR;                                          /* THGSR            */
    uint8  dummy261[74];                                   /* Reserved         */
    uint8  SGSTCR0;                                        /* SGSTCR0          */
    uint8  dummy262[15];                                   /* Reserved         */
    uint8  SGCR0;                                          /* SGCR0            */
    ...
    uint8  dummy266[7];                                    /* Reserved         */
    uint8  SGSR0;                                          /* SGSR0            */
    uint8  dummy267[11];                                   /* Reserved         */
    uint8  ULLMSR0;                                        /* ULLMSR0          */
    uint8  dummy268[79];                                   /* Reserved         */
    uint8  SGSTCR1;                                        /* SGSTCR1          */
    uint8  dummy269[15];                                   /* Reserved         */
    uint8  SGCR1;                                          /* SGCR1            */
    ...
    uint8  dummy273[7];                                    /* Reserved         */
    uint8  SGSR1;                                          /* SGSR1            */
    uint8  dummy274[11];                                   /* Reserved         */
    uint8  ULLMSR1;                                        /* ULLMSR1          */
    uint8  dummy275[79];                                   /* Reserved         */
    uint8  SGSTCR2;                                        /* SGSTCR2          */
    uint8  dummy276[15];                                   /* Reserved         */
    uint8  SGCR2;                                          /* SGCR2            */
    ...
    uint8  dummy280[7];                                    /* Reserved         */
    uint8  SGSR2;                                          /* SGSR2            */
    uint8  dummy281[11];                                   /* Reserved         */
    uint8  ULLMSR2;                                        /* ULLMSR2          */
    uint8  dummy282[79];                                   /* Reserved         */
...
{                                                          /* Module           */
    ...
    uint32 ADRUM;                                          /* ADRUM            */
    uint8  dummy326[1];                                    /* Reserved         */
    R_type0 ENUM;                                          /* ENUM             */
    uint8  dummy327[18];                                   /* Reserved         */
...
#define RSENT       ((volatile R_RSENT0 *)0xFFCDC000) /* RSENT[2] */
