...
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx20(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx10(void);
...
extern FUNC(void, OS_CODE) Os_Entry_ISR0p5ms(void);
