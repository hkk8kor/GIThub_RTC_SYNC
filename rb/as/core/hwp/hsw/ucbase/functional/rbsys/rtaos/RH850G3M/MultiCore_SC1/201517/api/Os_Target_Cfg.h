...
#define OS_CAT1_TRACKER_EXCMDP Os_RunningCat1ISR0
#define OS_CAT1_ID_EXCPIE (5U)
#define OS_CAT1_TRACKER_EXCPIE Os_RunningCat1ISR0
...
#ifndef OS_MULTICORE_DEFS
/* Multi-core defines needed to get the CoreID */
#define OS_HTCFG0 (0U)
#define OS_PEID_BIT1 (17U)
#define OS_CTPSW (17U)

#endif /* OS_MULTICORE_DEFS */
/* ------------------------------------------------- */
