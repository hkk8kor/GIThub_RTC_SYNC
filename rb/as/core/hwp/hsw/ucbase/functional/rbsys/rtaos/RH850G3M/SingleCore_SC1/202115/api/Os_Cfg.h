...
#define TaskBaseCtrlCycx2 (&Os_const_tasks0[4])
#define OS_TPL_FOR_TaskBaseCtrlCycx2 (4U) /* [$UKS 2007] */
...
#define TaskBaseCtrlCycx1Low (&Os_const_tasks0[5])
#define OS_TPL_FOR_TaskBaseCtrlCycx1Low (5U) /* [$UKS 2007] */
...
#define TaskFlexray (&Os_const_tasks0[6])
#define OS_TPL_FOR_TaskFlexray (6U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskFlexray (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskFlexray (6U) /* [$UKS 2185] */
DeclareTask(TaskFlexray)
#define TaskBaseCtrlCycx1High (&Os_const_tasks0[7])
#define OS_TPL_FOR_TaskBaseCtrlCycx1High (7U) /* [$UKS 2007] */
...
#define TaskTPSWKillCore1 (&Os_const_tasks0[13])
#define OS_TPL_FOR_TaskTPSWKillCore1 (13U) /* [$UKS 2007] */
