...
#define TaskBaseCtrlCycx20 (&Os_const_tasks0[1])
#define OS_TPL_FOR_TaskBaseCtrlCycx20 (1U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx20 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx20 (1U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx20)
#define TaskBaseCtrlCycx10 (&Os_const_tasks0[2])
#define OS_TPL_FOR_TaskBaseCtrlCycx10 (2U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx10 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx10 (2U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx10)
#define TaskBaseCtrlCycx8 (&Os_const_tasks0[3])
#define OS_TPL_FOR_TaskBaseCtrlCycx8 (3U) /* [$UKS 2007] */
...
#define TaskBaseCtrlCycx4 (&Os_const_tasks0[4])
#define OS_TPL_FOR_TaskBaseCtrlCycx4 (4U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx4 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx4 (4U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx4)
#define TaskBaseCtrlCycx2p (&Os_const_tasks0[5])
#define OS_TPL_FOR_TaskBaseCtrlCycx2p (5U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx2p (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx2p (5U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx2p)
#define TaskBaseCtrlCycx2 (&Os_const_tasks0[6])
#define OS_TPL_FOR_TaskBaseCtrlCycx2 (6U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx2 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx2 (6U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx2)
#define TaskBaseCtrlCycx1Low (&Os_const_tasks0[7])
#define OS_TPL_FOR_TaskBaseCtrlCycx1Low (7U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx1Low (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx1Low (7U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx1Low)
#define TaskFlexray (&Os_const_tasks0[8])
#define OS_TPL_FOR_TaskFlexray (8U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskFlexray (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskFlexray (8U) /* [$UKS 2185] */
DeclareTask(TaskFlexray)
#define TaskBaseCtrlCycx1High (&Os_const_tasks0[9])
#define OS_TPL_FOR_TaskBaseCtrlCycx1High (9U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskBaseCtrlCycx1High (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskBaseCtrlCycx1High (9U) /* [$UKS 2185] */
DeclareTask(TaskBaseCtrlCycx1High)
#define Task1ms (&Os_const_tasks0[10])
#define OS_TPL_FOR_Task1ms (10U) /* [$UKS 2007] */
#define OS_IMASK_FOR_Task1ms (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_Task1ms (10U) /* [$UKS 2185] */
DeclareTask(Task1ms)
#define Task0p5ms (&Os_const_tasks0[11])
#define OS_TPL_FOR_Task0p5ms (11U) /* [$UKS 2007] */
#define OS_IMASK_FOR_Task0p5ms (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_Task0p5ms (11U) /* [$UKS 2185] */
DeclareTask(Task0p5ms)
#define TaskInitP (&Os_const_tasks0[12])
#define OS_TPL_FOR_TaskInitP (12U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskInitP (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskInitP (12U) /* [$UKS 2185] */
DeclareTask(TaskInitP)
#define TaskInit (&Os_const_tasks0[13])
#define OS_TPL_FOR_TaskInit (13U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskInit (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskInit (13U) /* [$UKS 2185] */
DeclareTask(TaskInit)
#define TaskTPSWKillCore0 (&Os_const_tasks0[14])
#define OS_TPL_FOR_TaskTPSWKillCore0 (14U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskTPSWKillCore0 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskTPSWKillCore0 (14U) /* [$UKS 2185] */
DeclareTask(TaskTPSWKillCore0)
#define TaskTPSWKillCore1 (&Os_const_tasks0[15])
#define OS_TPL_FOR_TaskTPSWKillCore1 (15U) /* [$UKS 2007] */
#define OS_IMASK_FOR_TaskTPSWKillCore1 (0x0000U) /* [$UKS 2009] */
#define OS_INDEX_FOR_TaskTPSWKillCore1 (15U) /* [$UKS 2185] */
...
DeclareISR(ISRSTM05)
#define ISR0p5ms (&Os_const_isrs[12U])
#define OS_IMASK_FOR_ISR0p5ms (0xFFFCU) /* [$UKS 2009] */
#define OS_INDEX_FOR_ISR0p5ms (12U) /* [$UKS 2186] */
DeclareISR(ISR0p5ms)
#define ISRSWINT0 (&Os_const_isrs[13U])
#define OS_IMASK_FOR_ISRSWINT0 (0xFFFEU) /* [$UKS 2009] */
#define OS_INDEX_FOR_ISRSWINT0 (13U) /* [$UKS 2186] */
...
#define RTE_RESOURCE_OS_APP_TrustedAppCore0 (&Os_const_resources[0U])
DeclareResource(RTE_RESOURCE_OS_APP_TrustedAppCore0)
#define RTE_RESOURCE_OS_APP_TrustedAppCore1 (&Os_const_resources[1U])
DeclareResource(RTE_RESOURCE_OS_APP_TrustedAppCore1)
...
#define Os_Cat1_b_EXCFPP (32U)
#define OS_IMASK_FOR_EXCFETRAP (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCFETRAP (33U)
#define OS_IMASK_FOR_EXCHVTRAP (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCHVTRAP (34U)
#define OS_IMASK_FOR_EXCMDP (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCMDP (35U)
#define OS_IMASK_FOR_EXCPIE (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCPIE (36U)
#define OS_IMASK_FOR_EXCUCPOP (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCUCPOP (37U)
#define OS_IMASK_FOR_b_EXCDEBUG (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_b_EXCDEBUG (38U)
#define OS_IMASK_FOR_b_EXCFEINT (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_b_EXCFEINT (39U)
#define OS_IMASK_FOR_b_EXCMAE (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_b_EXCMAE (40U)
#define OS_IMASK_FOR_b_EXCRIE (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_b_EXCRIE (41U)
#define OS_IMASK_FOR_EXCFENMI (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_EXCFENMI (42U)
#define OS_IMASK_FOR_b_EXCSYSERR (0xFFFFU) /* [$UKS 2009] */
#define Os_Cat1_b_EXCSYSERR (43U)
