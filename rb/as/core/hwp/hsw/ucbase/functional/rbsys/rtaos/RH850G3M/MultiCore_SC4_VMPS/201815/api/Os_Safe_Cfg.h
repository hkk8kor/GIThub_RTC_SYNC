...
#define OS_NUM_TRUSTED_FUNCTIONS (2U)
#define OS_NUM_IOC_CALLBACK_FUNCTIONS (Os_const_ioc_function_count) /* [$OSCPFlex 18] */
#define OS_NUM_EVENTS (0U)
#define OS_NUM_TASKS (18U)
...
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx200Background(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskEventCtrlExtPrio2(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskEventCtrlExtPrio1(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx24(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx8(void);
extern FUNC(void, OS_CODE) Os_Entry_TaskBaseCtrlCycx4pLow(void);
...
extern FUNC(void, OS_CODE) Os_Entry_ISRFLX1LINE0(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRMCAN0I0(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRMCAN1I0(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRMCAN2I0(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRMTTCANI0(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRRLIN30RX(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRRLIN30STATUS(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRRLIN31RX(void);
extern FUNC(void, OS_CODE) Os_Entry_ISRRLIN31STATUS(void);
...
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_START_SEC_UNTRUSTEDAPPCORE0_LIB
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) TRUSTED_UntrustedFuncCore0(TrustedFunctionIndexType FunctionIndex, TrustedFunctionParameterRefType FunctionParams) /* [$UKS 1268] */;
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_UNTRUSTEDAPPCORE0_LIB
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_START_SEC_UNTRUSTEDAPPCORE1_LIB
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) TRUSTED_UntrustedFuncCore1(TrustedFunctionIndexType FunctionIndex, TrustedFunctionParameterRefType FunctionParams) /* [$UKS 1268] */;
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_UNTRUSTEDAPPCORE1_LIB
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
