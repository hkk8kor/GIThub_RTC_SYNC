...
/* used interfaces */
#include "RBSYS_OPBT_U2a_config.h"
...
RBSYS_SANITYCHECK_SIZE(tbpa0OtpSettings, 0x200, 0x300);
...
RBSYS_SANITYCHECK_SIZE(tbpa0Config1, 0x3E0, 0x600);
...
#if( (RBFS_TargetDevice == RBFS_TargetDevice_RenesasM2) || (RBFS_TargetDevice == RBFS_TargetDevice_RenesasM3) )
  #define OPBT9  (0xFFF1F0FEu)    // H'FF3213C4 OPBT9 //< for M2/M3: Write Emulation Mode = 0 (see 1326633: [RBSYS][U2A-D6] Clarify setting of OPBT9 with REL)
#elif( (RBFS_TargetDevice == RBFS_TargetDevice_RenesasD7) \
    || (RBFS_TargetDevice == RBFS_TargetDevice_RenesasM6) )
  #define OPBT9  (0xFFF1F0FFu)    // H'FF3213C4 OPBT9 //< for M6/D7: Write Emulation Mode = 1 (see 1326633: [RBSYS][U2A-D6] Clarify setting of OPBT9 with REL)
#endif
