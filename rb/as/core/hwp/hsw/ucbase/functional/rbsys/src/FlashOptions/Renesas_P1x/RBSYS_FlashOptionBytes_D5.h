#ifndef RBSYS_FLASHOPTIONBYTES_D5_H__
#define RBSYS_FLASHOPTIONBYTES_D5_H__
 ...
 *
 * @file
 * @brief Flash Option Bytes defines for Renesas D5
 *
 * @copyright
...
#define EMF               (0x07u)  /* EMF (Emulation mode select flag) */
