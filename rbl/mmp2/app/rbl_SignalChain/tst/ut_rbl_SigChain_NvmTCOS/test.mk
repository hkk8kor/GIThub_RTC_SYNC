#
# Generated makefile for test "ut_rbl_SigChain_NvmTCOS"
#
...
#
THIS_TEST := ut_rbl_SigChain_NvmTCOS

#
# Test script file
#
ut_rbl_SigChain_NvmTCOS_TESTOBJ := ut_rbl_SigChain_NvmTCOS

#
# Software under test
#
ut_rbl_SigChain_NvmTCOS_SUTOBJ := rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS

#
# Compile and link as 'C' or 'CXX'
#
ut_rbl_SigChain_NvmTCOS_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_rbl_SigChain_NvmTCOS_EXTLIBS := 

#
# Additional object files to link
#
ut_rbl_SigChain_NvmTCOS_EXTOBJS := 

#
# Additional defines for this test
#
ut_rbl_SigChain_NvmTCOS_DEFINES := _lint 

#
# Additional includes for this test
#
ut_rbl_SigChain_NvmTCOS_INCLUDES := ../../../src_out/rte \
                                    ../../../src_out/ice_gen \
                                    ../../../src_out/cgen \
                                    ...
                                    ../../../../../rb/as/core/hwp/hsw/ucbase/functional/rbsys/src/SystemMemoryProtection \
                                    ...
                                    ../../../../../rbl/mmp2/cust/app/rbl_ImuCustIf/common/api \
                                    ../../../../../rbl/mmp2/cust/app/rbl_ImuCustIf/common/src \
...
#
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.o : ../../../../../rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.c
	$(MKDIR_CMD) -p ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain/src
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_rbl_SigChain_NvmTCOS_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_rbl_SigChain_NvmTCOS_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_rbl_SigChain_NvmTCOS_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_rbl_SigChain_NvmTCOS/ut_rbl_SigChain_NvmTCOS.o : ut_rbl_SigChain_NvmTCOS/ut_rbl_SigChain_NvmTCOS.c
	$(MKDIR_CMD) -p ut_rbl_SigChain_NvmTCOS
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_rbl_SigChain_NvmTCOS/ut_rbl_SigChain_NvmTCOS.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_rbl_SigChain_NvmTCOS_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_rbl_SigChain_NvmTCOS_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_rbl_SigChain_NvmTCOS_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_rbl_SigChain_NvmTCOS_TEST_EXE) : \
	$(ut_rbl_SigChain_NvmTCOS_SUTOBJ_FILENAMES) \
	$(ut_rbl_SigChain_NvmTCOS_TESTOBJ_FILENAMES) \
	$(ut_rbl_SigChain_NvmTCOS_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_rbl_SigChain_NvmTCOS_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_rbl_SigChain_NvmTCOS_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_rbl_SigChain_NvmTCOS,$(subst %EXTOBJS%,$(ut_rbl_SigChain_NvmTCOS_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_rbl_SigChain_NvmTCOS successfully

#
# Rule for running the test executable
#
$(ut_rbl_SigChain_NvmTCOS_CTR_FILE) : $(ut_rbl_SigChain_NvmTCOS_TEST_EXE)
...
#
$(ut_rbl_SigChain_NvmTCOS_RUN) : $(ut_rbl_SigChain_NvmTCOS_CTR_FILE)
...
$(ut_rbl_SigChain_NvmTCOS_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_rbl_SigChain_NvmTCOS_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.c,$(DYNAMIC_THIS_TEST)/ut_rbl_SigChain_NvmTCOS.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_rbl_SigChain_NvmTCOS_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_rbl_SigChain_NvmTCOS_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_rbl_SigChain_NvmTCOS_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_rbl_SigChain_NvmTCOS_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain/src : ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain
	-@$(MKDIR_CMD) $@
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain : ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app
	-@$(MKDIR_CMD) $@
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app : ut_rbl_SigChain_NvmTCOS/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_rbl_SigChain_NvmTCOS/rbl/mmp2 : ut_rbl_SigChain_NvmTCOS/rbl
	-@$(MKDIR_CMD) $@
ut_rbl_SigChain_NvmTCOS/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.o : ../../ipg.cop
ut_rbl_SigChain_NvmTCOS/rbl/mmp2/app/rbl_SignalChain/src/rbl_SigChain_NvmTCOS.o : ut_rbl_SigChain_NvmTCOS/ipg.cop
ut_rbl_SigChain_NvmTCOS/ut_rbl_SigChain_NvmTCOS.o : ../../ipg.cop
ut_rbl_SigChain_NvmTCOS/ut_rbl_SigChain_NvmTCOS.o : ut_rbl_SigChain_NvmTCOS/ipg.cop
