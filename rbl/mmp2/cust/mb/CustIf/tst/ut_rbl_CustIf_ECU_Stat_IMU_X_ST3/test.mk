#
# Generated makefile for test "ut_rbl_CustIf_ECU_Stat_IMU_X_ST3"
#
...
#
THIS_TEST := ut_rbl_CustIf_ECU_Stat_IMU_X_ST3

#
# Test script file
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_TESTOBJ := ut_rbl_CustIf_ECU_Stat_IMU_X_ST3

#
# Software under test
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_SUTOBJ := rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3

#
# Compile and link as 'C' or 'CXX'
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_EXTLIBS := 

#
# Additional object files to link
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_EXTOBJS := 

#
# Additional defines for this test
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_DEFINES := _lint 

#
# Additional includes for this test
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_INCLUDES := ../../../src_out/rte \
                                             ../../../src_out/ice_gen \
                                             ../../../src_out/cgen \
...
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ../../../../../rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.c
	$(MKDIR_CMD) -p ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf/src
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.c
	$(MKDIR_CMD) -p ut_rbl_CustIf_ECU_Stat_IMU_X_ST3
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_TEST_EXE) : \
	$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_SUTOBJ_FILENAMES) \
	$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_TESTOBJ_FILENAMES) \
	$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3,$(subst %EXTOBJS%,$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_rbl_CustIf_ECU_Stat_IMU_X_ST3 successfully

#
# Rule for running the test executable
#
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_CTR_FILE) : $(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_TEST_EXE)
...
#
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_RUN) : $(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_CTR_FILE)
...
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.c,$(DYNAMIC_THIS_TEST)/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_rbl_CustIf_ECU_Stat_IMU_X_ST3_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf/src : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf
	-@$(MKDIR_CMD) $@
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2 : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl
	-@$(MKDIR_CMD) $@
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ../../ipg.cop
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/rbl/mmp2/cust/mb/rbl_CustIf/src/rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ipg.cop
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ../../ipg.cop
ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ut_rbl_CustIf_ECU_Stat_IMU_X_ST3.o : ut_rbl_CustIf_ECU_Stat_IMU_X_ST3/ipg.cop
