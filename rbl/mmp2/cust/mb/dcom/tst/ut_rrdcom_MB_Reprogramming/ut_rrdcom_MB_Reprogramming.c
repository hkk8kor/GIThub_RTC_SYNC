...
/*****************************************************************************/
/*
 *    Filename: ut_rrdcom_MB_Reprogramming.c
 *    Author: ZDE1KOR
 *    Generated on: 21-Nov-2022 11:36:44
 *    Generated from: rrdcom_MB_Reprogramming.c
 */
/*****************************************************************************/
...
typedef struct rrdcom_MB_Reprogramming_av_struct { volatile dcom_BackUp_RAM_tst * ref_DcmAppl_BackUp_RAM; } rrdcom_MB_Reprogramming_av_struct;
extern rrdcom_MB_Reprogramming_av_struct av_rrdcom_MB_Reprogramming;

/* Expected variables for global data */
uint16 expected_dcom_Requested_Tester;
boolean expected_rba_DcmPma_PlantModeStatus_b;
uint8 expected_Dcm_ctDiaSess_u8;
typedef struct expected_rrdcom_MB_Reprogramming_av_struct { dcom_BackUp_RAM_tst ref_DcmAppl_BackUp_RAM; } expected_rrdcom_MB_Reprogramming_av_struct;
expected_rrdcom_MB_Reprogramming_av_struct expected_av_rrdcom_MB_Reprogramming;

/* This function initialises global data to default values. This function       */
/* is called by every test case so must not contain test case specific settings */
static void initialise_global_data(){
    INITIALISE(ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM));
...
static void initialise_expected_global_data(){
    COPY_TO_EXPECTED(ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM), ACCESS_EXPECTED_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM));
...
static void check_global_data(){
    CHECK_MEMORY("ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM)", &ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM), &ACCESS_EXPECTED_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM), sizeof(ACCESS_EXPECTED_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM)));
...
int main()
{
    ...
    OPEN_LOG("ut_rrdcom_MB_Reprogramming.ctr", false, 100);
...
#endif
    rule_set("*", "*");
    EXPORT_COVERAGE("ut_rrdcom_MB_Reprogramming.cov", cppca_export_replace);
}
...
if (doIt) {
    ...
    START_TEST("46404: UTC_dcom_SetProgConditions",
        ...
        uint16 dcom_Requested_Tester;
           	   	  ...
           	   	  ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Start_Request_Inverted = 0xFF;
           	   	  ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = 0xFF;
       	   #endif
           ...
           #if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
                   CHECK_U_INT(ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Start_Request_Inverted, DCOM_REQPROGREQUESTINVERTED);
           #if (RBFS_DcomSecondTesterSupport == RBFS_DcomSecondTesterSupport_ON)
                   CHECK_U_INT(ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason, DCOM_PROGRAMMINGSESSION_2NDTESTER);
           #else
                   CHECK_U_INT(ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason, DCOM_PROGRAMMINGSESSION);
           #endif
           #endif
...
if (doIt) {
    ...
    START_TEST("47778: UTC_rrdcom_MB_Reprogramming_DcmAppl_DcmGetStoreType",
...
if (doIt) {
    ...
    START_TEST("47779: UTC_rrdcom_MB_Reprogramming_DcmAppl_Switch_DcmExecuteDscReset",
...
if (doIt) {
    ...
    START_TEST("47782: UTC_rrdcom_MB_Reprogramming_Dcm_SetProgConditions",
...
#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
		ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Start_Request_Inverted = 0x55;
		ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = 0x55;
#endif
...
if (doIt) {
    ...
    START_TEST("47781: UTC_rrdcom_MB_Reprogramming_Dcm_GetProgConditions",
           ...
           START_STEP("1_NTS", true);
#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
			ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = 0;
#endif
			/* Expected Call Sequence  */
			EXPECTED_CALLS("");
...
#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
			ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = DCOM_DEFAULTSESSION;
#endif
		...
		START_STEP("3_NTS", true);
					...
					ProgConditions->ReqResLen = 0x00;
		#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
					ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = DCOM_DEFAULTSESSION_2NDTESTER;
		#endif
		...
		START_STEP("4_NTS", true);
			...
			ProgConditions->ReqResLen = 0x00;
#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
			ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = DCOM_HARDRESET;
#endif
		...
		START_STEP("5_NTS", true);
					...
					ProgConditions->ReqResLen = 0x00;
		#if (RBFS_OEMBootloader == RBFS_OEMBootloader_Yes)
					ACCESS_VARIABLE(rrdcom_MB_Reprogramming, DcmAppl_BackUp_RAM).Bldr_Reset_Reason = DCOM_HARDRESET_2NDTESTER;
		#endif
