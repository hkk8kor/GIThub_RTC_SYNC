#
# Generated makefile for test "ut_DcmAppl_DcmControlDtcSettingEnableStatus"
#
...
#
THIS_TEST := ut_DcmAppl_DcmControlDtcSettingEnableStatus

#
# Test script file
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_TESTOBJ := ut_DcmAppl_DcmControlDtcSettingEnableStatus

#
# Software under test
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_SUTOBJ := rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus

#
# Compile and link as 'C' or 'CXX'
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_EXTLIBS := 

#
# Additional object files to link
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_EXTOBJS := 

#
# Additional defines for this test
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_DEFINES := _lint 

#
# Additional includes for this test
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus_INCLUDES := ../../Cantata/tests/ut_DcmAppl_DcmControlDtcSettingEnableStatus \
                                                        ../../../src_out/rte \
                                                        ../../../src_out/ice_gen \
                                                        ../../../src_out/cgen \
...
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.o : ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src/cubas
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus/ut_DcmAppl_DcmControlDtcSettingEnableStatus.o : ut_DcmAppl_DcmControlDtcSettingEnableStatus/ut_DcmAppl_DcmControlDtcSettingEnableStatus.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmControlDtcSettingEnableStatus
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_DcmAppl_DcmControlDtcSettingEnableStatus/ut_DcmAppl_DcmControlDtcSettingEnableStatus.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_TEST_EXE) : \
	$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_SUTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_TESTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmControlDtcSettingEnableStatus,$(subst %EXTOBJS%,$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_DcmAppl_DcmControlDtcSettingEnableStatus successfully

#
# Rule for running the test executable
#
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_CTR_FILE) : $(ut_DcmAppl_DcmControlDtcSettingEnableStatus_TEST_EXE)
...
#
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_RUN) : $(ut_DcmAppl_DcmControlDtcSettingEnableStatus_CTR_FILE)
...
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmControlDtcSettingEnableStatus_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.c,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmControlDtcSettingEnableStatus.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmControlDtcSettingEnableStatus_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_DcmAppl_DcmControlDtcSettingEnableStatus_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_DcmAppl_DcmControlDtcSettingEnableStatus_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src/cubas : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2 : ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.o : ../../ipg.cop
ut_DcmAppl_DcmControlDtcSettingEnableStatus/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmControlDtcSettingEnableStatus.o : ut_DcmAppl_DcmControlDtcSettingEnableStatus/ipg.cop
ut_DcmAppl_DcmControlDtcSettingEnableStatus/ut_DcmAppl_DcmControlDtcSettingEnableStatus.o : ../../ipg.cop
ut_DcmAppl_DcmControlDtcSettingEnableStatus/ut_DcmAppl_DcmControlDtcSettingEnableStatus.o : ut_DcmAppl_DcmControlDtcSettingEnableStatus/ipg.cop
