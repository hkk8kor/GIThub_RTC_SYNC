...
/*****************************************************************************/
/*
 *    Filename: ut_DcmAppl_DcmControlDtcSettingEnableStatus.c
 *    Author: VQQ1KOR
 *    Generated on: 04-Nov-2022 11:57:42
 *    Generated from: DcmAppl_DcmControlDtcSettingEnableStatus.c
 */
/*****************************************************************************/
...
/* Global Functions */
extern FUNC (void, DCM_APPL_CODE) DcmAppl_DcmControlDtcSettingEnableStatus(VAR(boolean,AUTOMATIC) ControlDtcSettingEnableStatus);
...
int main()
{
    ...
    OPEN_LOG("ut_DcmAppl_DcmControlDtcSettingEnableStatus.ctr", false, 100);
    START_SCRIPT("DcmAppl_DcmControlDtcSettingEnableStatus", true);
...
void run_tests()
{
    ...
    rule_set("*", "*");
    EXPORT_COVERAGE("ut_DcmAppl_DcmControlDtcSettingEnableStatus.cov", cppca_export_replace);
#endif
}
...
if (doIt) {
    ...
    START_TEST("48789: [MMP2.1x] UTC_dcom_cubas_DcmAppl_DcmControlDtcSettingEnableStatus",
