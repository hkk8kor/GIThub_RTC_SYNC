#
# Generated makefile for test "ut_dcom_MB_RollbackProtection"
#
...
#
THIS_TEST := ut_dcom_MB_RollbackProtection

#
# Test script file
#
ut_dcom_MB_RollbackProtection_TESTOBJ := ut_dcom_MB_RollbackProtection

#
# Software under test
#
ut_dcom_MB_RollbackProtection_SUTOBJ := rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection

#
# Compile and link as 'C' or 'CXX'
#
ut_dcom_MB_RollbackProtection_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_dcom_MB_RollbackProtection_EXTLIBS := 

#
# Additional object files to link
#
ut_dcom_MB_RollbackProtection_EXTOBJS := 

#
# Additional defines for this test
#
ut_dcom_MB_RollbackProtection_DEFINES := _lint 

#
# Additional includes for this test
#
ut_dcom_MB_RollbackProtection_INCLUDES := ../../../src_out/rte \
                                          ../../../src_out/ice_gen \
                                          ../../../src_out/cgen \
...
#
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.o : ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.c
	$(MKDIR_CMD) -p ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom/src
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_dcom_MB_RollbackProtection_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_dcom_MB_RollbackProtection_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_dcom_MB_RollbackProtection_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_dcom_MB_RollbackProtection/ut_dcom_MB_RollbackProtection.o : ut_dcom_MB_RollbackProtection/ut_dcom_MB_RollbackProtection.c
	$(MKDIR_CMD) -p ut_dcom_MB_RollbackProtection
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_dcom_MB_RollbackProtection/ut_dcom_MB_RollbackProtection.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_dcom_MB_RollbackProtection_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_dcom_MB_RollbackProtection_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_dcom_MB_RollbackProtection_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_dcom_MB_RollbackProtection_TEST_EXE) : \
	$(ut_dcom_MB_RollbackProtection_SUTOBJ_FILENAMES) \
	$(ut_dcom_MB_RollbackProtection_TESTOBJ_FILENAMES) \
	$(ut_dcom_MB_RollbackProtection_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_dcom_MB_RollbackProtection_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_dcom_MB_RollbackProtection_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_dcom_MB_RollbackProtection,$(subst %EXTOBJS%,$(ut_dcom_MB_RollbackProtection_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_dcom_MB_RollbackProtection successfully

#
# Rule for running the test executable
#
$(ut_dcom_MB_RollbackProtection_CTR_FILE) : $(ut_dcom_MB_RollbackProtection_TEST_EXE)
...
#
$(ut_dcom_MB_RollbackProtection_RUN) : $(ut_dcom_MB_RollbackProtection_CTR_FILE)
...
$(ut_dcom_MB_RollbackProtection_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_dcom_MB_RollbackProtection_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.c,$(DYNAMIC_THIS_TEST)/ut_dcom_MB_RollbackProtection.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_dcom_MB_RollbackProtection_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_dcom_MB_RollbackProtection_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_dcom_MB_RollbackProtection_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_dcom_MB_RollbackProtection_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom/src : ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom
	-@$(MKDIR_CMD) $@
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom : ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb : ut_dcom_MB_RollbackProtection/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust : ut_dcom_MB_RollbackProtection/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_dcom_MB_RollbackProtection/rbl/mmp2 : ut_dcom_MB_RollbackProtection/rbl
	-@$(MKDIR_CMD) $@
ut_dcom_MB_RollbackProtection/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.o : ../../ipg.cop
ut_dcom_MB_RollbackProtection/rbl/mmp2/cust/mb/rbl_dcom/src/dcom_MB_RollbackProtection.o : ut_dcom_MB_RollbackProtection/ipg.cop
ut_dcom_MB_RollbackProtection/ut_dcom_MB_RollbackProtection.o : ../../ipg.cop
ut_dcom_MB_RollbackProtection/ut_dcom_MB_RollbackProtection.o : ut_dcom_MB_RollbackProtection/ipg.cop
