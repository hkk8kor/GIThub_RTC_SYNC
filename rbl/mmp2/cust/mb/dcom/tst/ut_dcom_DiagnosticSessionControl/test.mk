#
# Generated makefile for test "ut_dcom_DiagnosticSessionControl"
#
...
#
THIS_TEST := ut_dcom_DiagnosticSessionControl

#
# Test script file
#
ut_dcom_DiagnosticSessionControl_TESTOBJ := ut_dcom_DiagnosticSessionControl

#
# Software under test
#
ut_dcom_DiagnosticSessionControl_SUTOBJ := rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl

#
# Compile and link as 'C' or 'CXX'
#
ut_dcom_DiagnosticSessionControl_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_dcom_DiagnosticSessionControl_EXTLIBS := 

#
# Additional object files to link
#
ut_dcom_DiagnosticSessionControl_EXTOBJS := 

#
# Additional defines for this test
#
ut_dcom_DiagnosticSessionControl_DEFINES := _lint 

#
# Additional includes for this test
#
ut_dcom_DiagnosticSessionControl_INCLUDES := ../../../src_out/rte \
                                             ../../../src_out/ice_gen \
                                             ../../../src_out/cgen \
...
#
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.o : ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.c
	$(MKDIR_CMD) -p ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src/common
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_dcom_DiagnosticSessionControl_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_dcom_DiagnosticSessionControl_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_dcom_DiagnosticSessionControl_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_dcom_DiagnosticSessionControl/ut_dcom_DiagnosticSessionControl.o : ut_dcom_DiagnosticSessionControl/ut_dcom_DiagnosticSessionControl.c
	$(MKDIR_CMD) -p ut_dcom_DiagnosticSessionControl
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_dcom_DiagnosticSessionControl/ut_dcom_DiagnosticSessionControl.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_dcom_DiagnosticSessionControl_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_dcom_DiagnosticSessionControl_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_dcom_DiagnosticSessionControl_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_dcom_DiagnosticSessionControl_TEST_EXE) : \
	$(ut_dcom_DiagnosticSessionControl_SUTOBJ_FILENAMES) \
	$(ut_dcom_DiagnosticSessionControl_TESTOBJ_FILENAMES) \
	$(ut_dcom_DiagnosticSessionControl_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_dcom_DiagnosticSessionControl_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_dcom_DiagnosticSessionControl_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_dcom_DiagnosticSessionControl,$(subst %EXTOBJS%,$(ut_dcom_DiagnosticSessionControl_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_dcom_DiagnosticSessionControl successfully

#
# Rule for running the test executable
#
$(ut_dcom_DiagnosticSessionControl_CTR_FILE) : $(ut_dcom_DiagnosticSessionControl_TEST_EXE)
...
#
$(ut_dcom_DiagnosticSessionControl_RUN) : $(ut_dcom_DiagnosticSessionControl_CTR_FILE)
...
$(ut_dcom_DiagnosticSessionControl_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_dcom_DiagnosticSessionControl_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.c,$(DYNAMIC_THIS_TEST)/ut_dcom_DiagnosticSessionControl.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_dcom_DiagnosticSessionControl_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_dcom_DiagnosticSessionControl_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_dcom_DiagnosticSessionControl_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_dcom_DiagnosticSessionControl_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src/common : ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src : ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom : ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb : ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust : ut_dcom_DiagnosticSessionControl/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl/mmp2 : ut_dcom_DiagnosticSessionControl/rbl
	-@$(MKDIR_CMD) $@
ut_dcom_DiagnosticSessionControl/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.o : ../../ipg.cop
ut_dcom_DiagnosticSessionControl/rbl/mmp2/cust/mb/rbl_dcom/src/common/dcom_DiagnosticSessionControl.o : ut_dcom_DiagnosticSessionControl/ipg.cop
ut_dcom_DiagnosticSessionControl/ut_dcom_DiagnosticSessionControl.o : ../../ipg.cop
ut_dcom_DiagnosticSessionControl/ut_dcom_DiagnosticSessionControl.o : ut_dcom_DiagnosticSessionControl/ipg.cop
