#
# Generated makefile for test "ut_DcmAppl_DcmGetRxPermission"
#
...
#
THIS_TEST := ut_DcmAppl_DcmGetRxPermission

#
# Test script file
#
ut_DcmAppl_DcmGetRxPermission_TESTOBJ := ut_DcmAppl_DcmGetRxPermission

#
# Software under test
#
ut_DcmAppl_DcmGetRxPermission_SUTOBJ := rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission

#
# Compile and link as 'C' or 'CXX'
#
ut_DcmAppl_DcmGetRxPermission_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_DcmAppl_DcmGetRxPermission_EXTLIBS := 

#
# Additional object files to link
#
ut_DcmAppl_DcmGetRxPermission_EXTOBJS := 

#
# Additional defines for this test
#
ut_DcmAppl_DcmGetRxPermission_DEFINES := _lint 

#
# Additional includes for this test
#
ut_DcmAppl_DcmGetRxPermission_INCLUDES := ../../../src_out/rte \
                                          ../../../src_out/ice_gen \
                                          ../../../src_out/cgen \
...
#
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.o : ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src/cubas
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmGetRxPermission_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmGetRxPermission_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmGetRxPermission_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_DcmAppl_DcmGetRxPermission/ut_DcmAppl_DcmGetRxPermission.o : ut_DcmAppl_DcmGetRxPermission/ut_DcmAppl_DcmGetRxPermission.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmGetRxPermission
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_DcmAppl_DcmGetRxPermission/ut_DcmAppl_DcmGetRxPermission.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmGetRxPermission_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmGetRxPermission_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmGetRxPermission_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_DcmAppl_DcmGetRxPermission_TEST_EXE) : \
	$(ut_DcmAppl_DcmGetRxPermission_SUTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmGetRxPermission_TESTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmGetRxPermission_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_DcmAppl_DcmGetRxPermission_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_DcmAppl_DcmGetRxPermission_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmGetRxPermission,$(subst %EXTOBJS%,$(ut_DcmAppl_DcmGetRxPermission_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_DcmAppl_DcmGetRxPermission successfully

#
# Rule for running the test executable
#
$(ut_DcmAppl_DcmGetRxPermission_CTR_FILE) : $(ut_DcmAppl_DcmGetRxPermission_TEST_EXE)
...
#
$(ut_DcmAppl_DcmGetRxPermission_RUN) : $(ut_DcmAppl_DcmGetRxPermission_CTR_FILE)
...
$(ut_DcmAppl_DcmGetRxPermission_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmGetRxPermission_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.c,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmGetRxPermission.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_DcmAppl_DcmGetRxPermission_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmGetRxPermission_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_DcmAppl_DcmGetRxPermission_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_DcmAppl_DcmGetRxPermission_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src/cubas : ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src : ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom : ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb : ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust : ut_DcmAppl_DcmGetRxPermission/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2 : ut_DcmAppl_DcmGetRxPermission/rbl
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRxPermission/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.o : ../../ipg.cop
ut_DcmAppl_DcmGetRxPermission/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRxPermission.o : ut_DcmAppl_DcmGetRxPermission/ipg.cop
ut_DcmAppl_DcmGetRxPermission/ut_DcmAppl_DcmGetRxPermission.o : ../../ipg.cop
ut_DcmAppl_DcmGetRxPermission/ut_DcmAppl_DcmGetRxPermission.o : ut_DcmAppl_DcmGetRxPermission/ipg.cop
