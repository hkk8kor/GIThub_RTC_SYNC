#
# Generated makefile for test "ut_DcmAppl_DcmGetRoeDTCInfo"
#
...
#
THIS_TEST := ut_DcmAppl_DcmGetRoeDTCInfo

#
# Test script file
#
ut_DcmAppl_DcmGetRoeDTCInfo_TESTOBJ := ut_DcmAppl_DcmGetRoeDTCInfo

#
# Software under test
#
ut_DcmAppl_DcmGetRoeDTCInfo_SUTOBJ := rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo

#
# Compile and link as 'C' or 'CXX'
#
ut_DcmAppl_DcmGetRoeDTCInfo_C_OR_CPP_MODE := C

#
# Additional libraries to link
#
ut_DcmAppl_DcmGetRoeDTCInfo_EXTLIBS := 

#
# Additional object files to link
#
ut_DcmAppl_DcmGetRoeDTCInfo_EXTOBJS := 

#
# Additional defines for this test
#
ut_DcmAppl_DcmGetRoeDTCInfo_DEFINES := _lint 

#
# Additional includes for this test
#
ut_DcmAppl_DcmGetRoeDTCInfo_INCLUDES := ../../../src_out/rte \
                                        ../../../src_out/ice_gen \
                                        ../../../src_out/cgen \
...
#
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas
	...
	-@$(ECHO_CMD_MED) ../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	-@$(QAC_CMD)
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmGetRoeDTCInfo_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmGetRoeDTCInfo_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmGetRoeDTCInfo_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for compiling the test script
#
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.c
	$(MKDIR_CMD) -p ut_DcmAppl_DcmGetRoeDTCInfo
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ,,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,0,0 >> $(CANTPP_TOP_LEVEL_LOG)
	-@$(ECHO_CMD_MED) ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.c > $(DYNAMIC_THIS_TEST)/filelist.lst
	$(subst %DEFINES%, $(foreach define,$(ut_DcmAppl_DcmGetRoeDTCInfo_ALL_DEFINES),$(DEFINE_OPT)$(define)), $(subst %INCLUDES%, $(foreach include,$(ut_DcmAppl_DcmGetRoeDTCInfo_ALL_INCLUDES),$(subst %s,$(include),$(INCLUDE_PATH_OPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/$(ut_DcmAppl_DcmGetRoeDTCInfo_SUTOBJ),$(COMPILE_CC_CMD))))

#
# Rule for linking the test executable
#
$(ut_DcmAppl_DcmGetRoeDTCInfo_TEST_EXE) : \
	$(ut_DcmAppl_DcmGetRoeDTCInfo_SUTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmGetRoeDTCInfo_TESTOBJ_FILENAMES) \
	$(ut_DcmAppl_DcmGetRoeDTCInfo_EXTRA_DEPENDS)
	@$(RM_CMD) $(DYNAMIC_THIS_TEST)/*.cov $(DYNAMIC_THIS_TEST)/*.ctr $(DYNAMIC_THIS_TEST)/*.ctg
	@$(ECHO_CMD_MED) ",,$(NUMBER_OF_TESTS),$(firstword $(subst /, ,$(dir $@))),1,0,0,1,0" >> $(CANTPP_TOP_LEVEL_LOG)
	$(subst %EXTLIBS%, $(foreach extlib,$(ut_DcmAppl_DcmGetRoeDTCInfo_ALL_EXTLIBS),$(subst %s,$(extlib),$(ut_DcmAppl_DcmGetRoeDTCInfo_LINK_EXTLIBOPT))), $(subst %n,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmGetRoeDTCInfo,$(subst %EXTOBJS%,$(ut_DcmAppl_DcmGetRoeDTCInfo_EXTOBJS),$(CC_LINK_CMD))))
	@$(ECHO_CMD_MED) Built ut_DcmAppl_DcmGetRoeDTCInfo successfully

#
# Rule for running the test executable
#
$(ut_DcmAppl_DcmGetRoeDTCInfo_CTR_FILE) : $(ut_DcmAppl_DcmGetRoeDTCInfo_TEST_EXE)
...
#
$(ut_DcmAppl_DcmGetRoeDTCInfo_RUN) : $(ut_DcmAppl_DcmGetRoeDTCInfo_CTR_FILE)
...
$(ut_DcmAppl_DcmGetRoeDTCInfo_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmGetRoeDTCInfo_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(ECHO_CMD_MED) Uploading test results to Cantata Server...
	@$(JAVA_CMD) -cp "$(CANTATA_INSTALL_DIR)/bin/client.jar" com.qas.cantata.client.control.CCLC filesToLoad=$(DYNAMIC_THIS_TEST)/.*.ctr,$(DYNAMIC_THIS_TEST)/.*.ctg,$(DYNAMIC_THIS_TEST)/.*.cov,../../../../../rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.c,$(DYNAMIC_THIS_TEST)/ut_DcmAppl_DcmGetRoeDTCInfo.c optionsFiles=../../ipg.cop,$(DYNAMIC_THIS_TEST)/ipg.cop 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
	@$(CTR_STATE_CMD)
else
$(ut_DcmAppl_DcmGetRoeDTCInfo_BUILD_AND_RUN) : 
	-@$(MAKE) $(ut_DcmAppl_DcmGetRoeDTCInfo_RUN) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
$(ut_DcmAppl_DcmGetRoeDTCInfo_BUILD_AND_RUN) : 
	@$(MAKE) $(ut_DcmAppl_DcmGetRoeDTCInfo_TEST_EXE) --warn-undefined-variables -s -f $(DYNAMIC_THIS_TEST)/test.mk 2>&1 | tee -a $(DYNAMIC_THIS_TEST)/$($(DYNAMIC_THIS_TEST)_LOG)
...
#
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas : ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src : ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom : ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb : ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust : ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2 : ut_DcmAppl_DcmGetRoeDTCInfo/rbl
	-@$(MKDIR_CMD) $@
ut_DcmAppl_DcmGetRoeDTCInfo/rbl : 
	-@$(MKDIR_CMD) $@

#
# Additional dependencies
#
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Bsw_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/ComStack_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/ComStack_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Compiler.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Compiler_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmCore_DslDsd_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_CC_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Cdi_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Cdtcs_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Dsc_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Rdtc_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Roe_Inf.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Uds_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm_Cfg_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Os_Compiler_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Platform_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Platform_Types_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Rte_Dcm_Type.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Std_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_DslDsd.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_DspUds.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_Version.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Lcfg_DslDsd.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Lcfg_DspUds.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/ice_gen/Dcm_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ../../ipg.cop
ut_DcmAppl_DcmGetRoeDTCInfo/rbl/mmp2/cust/mb/rbl_dcom/src/cubas/DcmAppl_DcmGetRoeDTCInfo.o : ut_DcmAppl_DcmGetRoeDTCInfo/ipg.cop
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Bsw_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/ComStack_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/ComStack_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Compiler.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Compiler_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmCore_DslDsd_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_CC_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Cdi_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Cdtcs_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Dsc_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Rdtc_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Roe_Inf.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/DcmDspUds_Uds_Pub.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm_Cfg_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Dcm_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Os_Compiler_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Platform_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Platform_Types_Cfg.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Rte_Dcm_Type.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../make/hdr_lnk/Std_Types.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_DslDsd.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_DspUds.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Cfg_Version.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Lcfg_DslDsd.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/bct/_out/Dcm_Lcfg_DspUds.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../../src_out/ice_gen/Dcm_MemMap.h
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ../../ipg.cop
ut_DcmAppl_DcmGetRoeDTCInfo/ut_DcmAppl_DcmGetRoeDTCInfo.o : ut_DcmAppl_DcmGetRoeDTCInfo/ipg.cop
