...
/*************************************************************************************************
                            CALLOUTS
     BE CAREFUL -> CHECK IF THIS IS REALLY NEEDED !!!
     USAGE OF THIS CALL-OUT DOES NOT BE INFLUENCING THE CC-BRAKE SYSTEM ARCHITECTURE !!!
*************************************************************************************************/
...
/*************************************************************************************************
  ...
  Description       :   In case of serious error conditions like consistency check failure or
...
/**********************************************************************************
  ...
  Description       :   This callout shall stop the given wakeup source(s) after unsuccessful wakeup validation.
  Parameter (in)    :   wakeupSource.
  Parameter (inout) :   None
  Parameter (out)   :   None
  Return value      :   None
